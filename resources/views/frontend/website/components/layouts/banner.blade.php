<section class="hero-banner banner-literacy">
    ...
    @php
        ...
        if ($currentScheduledConference->date_start && $currentScheduledConference->date_end) {
            // If conference hasn't started yet, countdown to start date
            if ($now->lt($currentScheduledConference->date_start)) {
                $countdownTarget = $currentScheduledConference->date_start;
            }
            // If conference has started but not ended, countdown to end date
            ...
            // If conference has ended, no countdown
            else {
                $countdownTarget = null;
            }
        } else {
            // Fallback to original logic if only one date is available
