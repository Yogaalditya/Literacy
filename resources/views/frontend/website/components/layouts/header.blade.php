            ...
            <div class="absolute top-3 right-4 hidden lg:block">
                <div class="flex items-center gap-3">
                    ...
                    <div class="navbar-custom-literacy rounded-full bg-white/10 backdrop-blur-md border border-white/20 shadow-md px-3 h-14 w-14 flex items-center justify-center">
                        ...
                        >
                            <!-- Sun Icon (Light Mode) -->
                            <svg x-cloak x-show="!isDark" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 scale-75 -translate-y-2" x-transition:enter-end="opacity-100 scale-100 translate-y-0" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100 scale-100 translate-y-0" x-transition:leave-end="opacity-0 scale-75 translate-y-2" class="h-5 w-5 text-gray-800 transition-transform duration-300 group-hover:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
